      ...
      onTap: (int index) {
        switch (index) {
          case 0: // 첫 번째 아이템 (Home) 이 선택된 경우.
            Navigator.pushNamed(context, '/nonMemberHome'); // '/nonMemberHome' 라우트로 이동.
            break;
          case 1: // 두 번째 아이템 (Reservation) 이 선택된 경우.
            Navigator.pushNamed(context, '/search'); // '/search' 라우트로 이동.
            break;
          default:
            // 추가적인 케이스를 처리할 수 있는 위치. 현재는 아무런 작업도 수행하지 않음.
        }
      },
